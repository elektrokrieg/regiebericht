...
const CACHE_NAME = 'regiebericht-v1';

const ASSETS = [
  '/regiebericht/',
  '/regiebericht/index.html',
  '/regiebericht/manifest.json',
  '/regiebericht/icon-192.png',
  '/regiebericht/icon-512.png',
    ...
    caches.match(event.request).then(cached => {
      ...
      return fetch(event.request).then(response => {
        ...
        if (event.request.mode === 'navigate') {
          return caches.match('/regiebericht/index.html');
        }
      });
    })
  );
